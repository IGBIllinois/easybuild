...
class PythonPackagePip(ExtensionEasyBlock):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(PythonPackagePip, self).__init__(*args, **kwargs)
    ...
    def extract_step(self):
        ...
        if self.cfg.get('unpack_sources', True):
            super(PythonPackagePip, self).extract_step()

    def prerun(self):
        """Prepare for installing Python package."""
        super(PythonPackagePip, self).prerun()
        self.prepare_python()

    def prepare_step(self, *args, **kwargs):
        """Prepare for building and installing this Python package."""
        super(PythonPackagePip, self).prepare_step(*args, **kwargs)
        self.prepare_python()
    ...
    def run(self, *args, **kwargs):
        ...
        super(PythonPackagePip, self).run(*args, **kwargs)
    ...
    def sanity_check_step(self, *args, **kwargs):
        ...
        return super(PythonPackagePip, self).sanity_check_step(*args, **kwargs)

    def make_module_req_guess(self):
        """
        Define list of subdirectories to consider for updating path-like environment variables ($PATH, etc.).
        """
        guesses = super(PythonPackagePip, self).make_module_req_guess()
    ...
    def make_module_extra(self, *args, **kwargs):
        ...
        return super(PythonPackagePip, self).make_module_extra(txt, *args, **kwargs)
